...
// This class should inherit from Vehicle and each motorcycle instance should,
// have a property called numWheels which has a value of 2.
...
class Garage {
  ...
  add(vehicle) {
    if (vehicle instanceof Vehicle === false) return "Only vehicles are allowed in here!!!"
